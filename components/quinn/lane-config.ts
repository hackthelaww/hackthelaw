...
export const STATUS_META: Record<string, { label: string; dot: DotTone }> = {
  compliant: { label: "Compliant", dot: "set" },
  partially_compliant: { label: "Partially compliant", dot: "urgent" },
  non_compliant: { label: "Non-compliant", dot: "urgent" },
  unclear: { label: "Unclear", dot: "outline" },
};
